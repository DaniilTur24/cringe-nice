  ...
  if (key === 'rejected_fine') {
    ...
    const roleHint = proposal.creator_role === 'detective'
      ...
      : isGhost
        ...
        : ''
    return `Сценарий rejected_fine. Адресат: ${name}. Жалоба отклонена; автор раскрыт и наказан на -3 балла; обвиняемого не называй. Стеби ложный донос. Суть: ${text}.${roleHint}`
  }
